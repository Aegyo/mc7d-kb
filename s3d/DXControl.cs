...
//				m_DDeviceX.ProcessKeyboardEvt();
		...
		public Vector3 HalfCamera(){ 
			Vector3 cpt=Scene.Camera.CameraPosition;
			Vector3 cvv=Scene.Camera.PointToLookAt;
			cpt.Add(cvv); cpt.Scale(0.5f);
			return cpt;
		}

		public Vector3 CloneShift(){
			Vector3 cpt=Scene.Camera.CameraPosition;
			Vector3 cvv=Scene.Camera.PointToLookAt;
			cpt.Subtract(cvv); cpt.Scale(0.1f);
			return cpt;
		}
